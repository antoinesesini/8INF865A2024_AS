...
import ca.uqac.etu.seance2.ui.theme.Seance2Theme
        ...
        setContent {
            Seance2Theme {
                Surface(
                    ...
                    //GreetingText(message = "Happy Birthday Sam!", from = "from Antoine", modifier = Modifier.padding(8.dp))
